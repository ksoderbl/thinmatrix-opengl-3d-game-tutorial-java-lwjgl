...
// https://www.youtube.com/watch?v=95WAAYsOifQ&list=PLRIWtICgwaX0u7Rf9zkZhLoLuZVfUksDP&index=25
...
public class MainGameLoop25
{
    ...
    public static void main(String[] args) {
        ...
        lights.add(light);
        // OpenGL 3D Game Tutorial 25: Multiple Lights
        lights.add(new Light(new Vector3f(-4000, 100, -2000), new Vector3f(1f, 0f, 0f)));
        lights.add(new Light(new Vector3f( 2000, 200, -4000), new Vector3f(0f, 1f, 0f)));
        lights.add(new Light(new Vector3f( 3000, 300,  3000), new Vector3f(0f, 0f, 1f)));
        
        MasterRenderer25 renderer = new MasterRenderer25();
