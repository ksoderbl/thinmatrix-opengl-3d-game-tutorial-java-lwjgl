...
public class NormalMappingShader extends ShaderProgram{
    ...
    private static final String VERTEX_FILE = "src/com/example/normalMappingRenderer/normalMapVShader.glsl";
    private static final String FRAGMENT_FILE = "src/com/example/normalMappingRenderer/normalMapFShader.glsl";
