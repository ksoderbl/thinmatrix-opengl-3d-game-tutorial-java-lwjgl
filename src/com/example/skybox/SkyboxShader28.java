...
public class SkyboxShader28 extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/com/example/skybox/skyboxVertexShader28.glsl";
    private static final String FRAGMENT_FILE = "src/com/example/skybox/skyboxFragmentShader28.glsl";
