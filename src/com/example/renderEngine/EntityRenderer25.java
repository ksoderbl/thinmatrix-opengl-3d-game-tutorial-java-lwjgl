...
public class EntityRenderer25 {
    
    private StaticShader25 shader;
    
    public EntityRenderer25(StaticShader25 shader, Matrix4f projectionMatrix) {
        this.shader = shader;
        shader.start();
    ...
    public void prepareTexturedModel(TexturedModel model) {
        ...
        if (texture.isHasTransparency()) {
            MasterRenderer25.disableCulling();
        }
    ...
    public void unbindTexturedModel() {
        MasterRenderer25.enableCulling();
