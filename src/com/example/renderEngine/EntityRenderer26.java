...
public class EntityRenderer26 {
    
    private StaticShader26 shader;
    
    public EntityRenderer26(StaticShader26 shader, Matrix4f projectionMatrix) {
        this.shader = shader;
        shader.start();
    ...
    public void prepareTexturedModel(TexturedModel model) {
        ...
        if (texture.isHasTransparency()) {
            MasterRenderer26.disableCulling();
        }
    ...
    public void unbindTexturedModel() {
        MasterRenderer26.enableCulling();
