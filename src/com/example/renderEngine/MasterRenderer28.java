...
import com.example.shaders.StaticShader26;
import com.example.skybox.Sky;
import com.example.skybox.SkyboxRenderer28;
import com.example.terrains.Terrain;
import com.example.terrains.TerrainShader26;

public class MasterRenderer28 {
    ...
    private TerrainRenderer26 terrainRenderer;
    private TerrainShader26 terrainShader = new TerrainShader26();

    private Map<TexturedModel, List<Entity>> entities = new HashMap<>();
    private List<Terrain> terrains = new ArrayList<>();
    
    private SkyboxRenderer28 skyboxRenderer;
    
    public MasterRenderer28(Loader loader) {
        enableCulling();
        ...
        skyboxRenderer = new SkyboxRenderer28(loader, projectionMatrix);
    }
