...
public class EntityRendererWater03 {
    
    private StaticShaderWater03 shader;
    
    public EntityRendererWater03(StaticShaderWater03 shader, Matrix4f projectionMatrix) {
        this.shader = shader;
        shader.start();
    ...
    public void prepareTexturedModel(TexturedModel model) {
        ...
        if (texture.isHasTransparency()) {
            MasterRendererWater03.disableCulling();
        }
    ...
    public void unbindTexturedModel() {
        MasterRendererWater03.enableCulling();
