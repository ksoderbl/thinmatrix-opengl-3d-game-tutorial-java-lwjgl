...
public class EntityRenderer16 {
    
    private StaticShader16 shader;
    
    public EntityRenderer16(StaticShader16 shader, Matrix4f projectionMatrix) {
        this.shader = shader;
        shader.start();
    ...
    public void prepareTexturedModel(TexturedModel model) {
        ...
        if (texture.isHasTransparency()) {
            MasterRenderer16.disableCulling();
        }
    ...
    public void unbindTexturedModel() {
        MasterRenderer16.enableCulling();
