...
public class StaticShader11 extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/com/example/shaders/vertexShader11.glsl";
    private static final String FRAGMENT_FILE = "src/com/example/shaders/fragmentShader11.glsl";
