...
public class InsertionSort35 {
     ...
     */
    public static void sortHighToLow(List<Particle35> list) {
        for (int i = 1; i < list.size(); i++) {
            Particle35 item = list.get(i);
    ...
    private static void sortUpHighToLow(List<Particle35> list, int i) {
        Particle35 item = list.get(i);
        int attemptPos = i - 1;
