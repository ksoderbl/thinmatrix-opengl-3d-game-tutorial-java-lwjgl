...
public class InsertionSort36 {
     ...
     */
    public static void sortHighToLow(List<Particle36> list) {
        for (int i = 1; i < list.size(); i++) {
            Particle36 item = list.get(i);
    ...
    private static void sortUpHighToLow(List<Particle36> list, int i) {
        Particle36 item = list.get(i);
        int attemptPos = i - 1;
