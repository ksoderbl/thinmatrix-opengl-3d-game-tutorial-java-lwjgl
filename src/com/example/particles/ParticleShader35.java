...
public class ParticleShader35 extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/com/example/particles/particleVShader35.glsl";
    private static final String FRAGMENT_FILE = "src/com/example/particles/particleFShader35.glsl";
