...
public class WaterShader08 extends ShaderProgram {
    ...
    private final static String VERTEX_FILE = "src/com/example/water/waterVertex08.glsl";
    private final static String FRAGMENT_FILE = "src/com/example/water/waterFragment08.glsl";
