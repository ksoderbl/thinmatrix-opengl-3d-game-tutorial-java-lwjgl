...
public class WaterShader01 extends ShaderProgram {
    ...
    private final static String VERTEX_FILE = "src/com/example/water/waterVertex01.glsl";
    private final static String FRAGMENT_FILE = "src/com/example/water/waterFragment01.glsl";
