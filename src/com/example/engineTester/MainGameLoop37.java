...
import com.example.terrains.World37;
import com.example.toolbox.MousePicker;
import com.example.water.WaterFrameBuffers;
import com.example.water.WaterRenderer37;
import com.example.water.WaterShader37;

public class MainGameLoop37
{
    public static void main(String[] args) {
        new MainGameLoop37();
    }

    String tutorial = "OpenGL 3D Game Tutorial 37: Procedural Terrain";
    ...
    public MainGameLoop37() {
        ...
        Sky sky = new Sky(0.7f, .8f, .9f, airDensity, airGradient);       
        ...
        WaterShader37 waterShader = new WaterShader37();
        WaterRenderer37 waterRenderer = new WaterRenderer37(loader, waterShader,
                renderer.getProjectionMatrix(), renderer.getNearPlane(), renderer.getFarPlane(), buffers, 0);
...
//                text.increasePosition(dt, 0f);
//                text2.increasePosition(dt, 0f);
//                text3.increasePosition(dt, 0f);
            // }
