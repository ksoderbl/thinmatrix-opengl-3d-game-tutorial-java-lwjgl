...
public class MainGameLoopWater06
{
    public static String title = "OpenGL Water Tutorial 6";
    public static String subTitle = "Fresnel Effect"; //
    ...
    public static void main(String[] args) {
        ...
        WaterShader06 waterShader = new WaterShader06();
        WaterRenderer06 waterRenderer = new WaterRenderer06(loader, waterShader, renderer.getProjectionMatrix(), buffers);
