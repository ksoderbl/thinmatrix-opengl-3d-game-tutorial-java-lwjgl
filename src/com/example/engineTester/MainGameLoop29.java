...
import com.example.renderEngine.MasterRenderer28;
...
import com.example.water.WaterRenderer08;
...
// https://www.youtube.com/watch?v=DLKN0jExRIM&list=PLRIWtICgwaX0u7Rf9zkZhLoLuZVfUksDP&index=30

// Raycasting
// http://antongerdelan.net/opengl/raycasting.html

public class MainGameLoop29
{
    public static void main(String[] args) {
        new MainGameLoop29();
    }
    
    String title = "OpenGL 3D Game Tutorial 29";
    String subTitle = "Mouse Picking";
    ...
    public MainGameLoop29() {
        ...
        Light lampLight = new Light(new Vector3f(ex, ey+14, ez), new Vector3f(0, 10, 20), new Vector3f(1, 0.01f, 0.002f));
