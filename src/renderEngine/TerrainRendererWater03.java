...
public class TerrainRendererWater03 {

    private TerrainShaderWater03 shader;

    public TerrainRendererWater03(TerrainShaderWater03 shader, Matrix4f projectionMatrix) {
        this.shader = shader;
        shader.start();
