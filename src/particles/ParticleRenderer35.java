...
public class ParticleRenderer35 {
    ...
    private ParticleShader35 shader;
    
    protected ParticleRenderer35(Loader loader, Matrix4f projectionMatrix) {
        quad = loader.loadToVAO(VERTICES, 2);
        shader = new ParticleShader35();
        shader.start();
        shader.loadProjectionMatrix(projectionMatrix);
        shader.stop();
    }
    
    protected void render(Map<ParticleTexture35, List<Particle35>> particles, Camera camera) {
