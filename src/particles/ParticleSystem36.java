...
public class ParticleSystem36 {
    ...
    public ParticleSystem36(ParticleTexture36 texture, float pps, float speed, float gravityComplient, float lifeLength, float scale) {
        this.pps = pps;
    ...
    private void emitParticle(Vector3f center) {
        ...
        new Particle36(texture, new Vector3f(center), velocity, gravityComplient, lifeLength, generateRotation(), scale);
    }
