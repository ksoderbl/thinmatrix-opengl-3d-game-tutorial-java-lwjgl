...
public class TerrainShader25 extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "src/shaders/terrainVertexShader25.glsl";
    private static final String FRAGMENT_FILE = "src/shaders/terrainFragmentShader25.glsl";
